...
class Settings():
    ...
    ASSETS_URL: str = 'http://127.0.0.1:8080/assets'
    API_V1_STR: str = ""
    SECRET_KEY: str = secrets.token_urlsafe(32)
    INIT_PASSWORD: str = "zm4228343"
    ...
    SQLALCHEMY_DATABASE_URI: Optional[PostgresDsn] = "mysql://root:zm4228343@127.0.0.1:3306/vueadmin?charset=utf8"
